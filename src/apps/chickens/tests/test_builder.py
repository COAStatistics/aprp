...
from apps.chickens.builder import direct
...
class BuilderTestCase(BuilderTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.start_date = datetime.date(year=2018, month=4, day=25)
        cls.end_date = datetime.date(year=2018, month=5, day=2)
