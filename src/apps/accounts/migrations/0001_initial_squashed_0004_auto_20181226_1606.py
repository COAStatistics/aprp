# -*- coding: utf-8 -*-
# Generated by Django 1.9.13 on 2019-03-22 07:43
...
class Migration(migrations.Migration):
    ...
    replaces = [('accounts', '0001_initial'), ('accounts', '0002_auto_20181023_1558'), ('accounts', '0003_userinformation_reporter'), ('accounts', '0004_auto_20181226_1606')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile', models.ImageField(blank=True, null=True, upload_to=apps.accounts.utils.upload_location, verbose_name='Profile')),
                ...
                ('event_editor', models.BooleanField(default=False, verbose_name='Event Editor')),
                ('menu_viewer', models.BooleanField(default=False, verbose_name='Menu Item Viewer')),
                ('watchlist_viewer', models.BooleanField(default=False, verbose_name='Watchlist Viewer')),
                ('reporter', models.BooleanField(default=False, verbose_name='Reporter')),
                ('alert_viewer', models.BooleanField(default=True, verbose_name='Alert Viewer')),
                ('monitor_info_viewer', models.BooleanField(default=True, verbose_name='Monitor Info Viewer')),
            ],
            options={
